...
{
    public class HydroshareAuthenticationHandler : AuthenticationHandler<HydroshareAuthenticationOptions>
    {
        ...
        public HydroshareAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new HydroshareAuthenticatedContext(Context, user, accessToken)
                {
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:hydroshare:name", context.Name, XmlSchemaString, Options.AuthenticationType));
                }
                if (!string.IsNullOrEmpty(context.Link))
                {
                    context.Identity.AddClaim(new Claim("urn:hydroshare:url", context.Link, XmlSchemaString, Options.AuthenticationType));
                }
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            ...
            var context = new HydroshareReturnEndpointContext(Context, ticket)
            {
