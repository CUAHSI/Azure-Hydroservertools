    ...
    public class ExportController : Controller
    {
        ...
        public FileStreamResult Download(int identifier, string viewName)
        {
            ...
            if (viewName == "sites")
            {
                ...
                var listOfRecords = (List<SiteModel>)BusinessObjectsUtils.GetRecordsFromSession<SiteModel>(instanceIdentifier, identifier);
            ...
            {
                var listOfRecords = (List<VariablesModel>)BusinessObjectsUtils.GetRecordsFromSession<VariablesModel>(instanceIdentifier, identifier);
                var result = WriteCsvToMemory(listOfRecords);
            ...
            if (viewName == "offsettypes")
            {
                ...
                var listOfRecords = (List<OffsetTypesModel>)BusinessObjectsUtils.GetRecordsFromSession<OffsetTypesModel>(instanceIdentifier, identifier);
            ...
            if (viewName == "sources")
            {
                ...
                var listOfRecords = (List<SourcesModel>)BusinessObjectsUtils.GetRecordsFromSession<SourcesModel>(instanceIdentifier, identifier);
            ...
            if (viewName == "methods")
            {
                var listOfRecords = (List<MethodModel>)BusinessObjectsUtils.GetRecordsFromSession<MethodModel>(instanceIdentifier, identifier);
            ...
            {
                var listOfRecords = (List<LabMethodModel>)BusinessObjectsUtils.GetRecordsFromSession<LabMethodModel>(instanceIdentifier, identifier);
            ...
            if (viewName == "samples")
            {
                var listOfRecords = (List<SampleModel>)BusinessObjectsUtils.GetRecordsFromSession<SampleModel>(instanceIdentifier, identifier);
            ...
            {
                var listOfRecords = (List<QualifiersModel>)BusinessObjectsUtils.GetRecordsFromSession<QualifiersModel>(instanceIdentifier, identifier);
            ...
            {
                var listOfRecords = (List<QualityControlLevelModel>)BusinessObjectsUtils.GetRecordsFromSession<QualityControlLevelModel>(instanceIdentifier, identifier);
            ...
            {
                var listOfRecords = (List<DataValuesModel>)BusinessObjectsUtils.GetRecordsFromSession<DataValuesModel>(instanceIdentifier, identifier);
            ...
            {
                var listOfRecords = (List<GroupDescriptionModel>)BusinessObjectsUtils.GetRecordsFromSession<GroupDescriptionModel>(instanceIdentifier, identifier);
            ...
            if (viewName == "groups")
            {
                var listOfRecords = (List<GroupsModel>)BusinessObjectsUtils.GetRecordsFromSession<GroupsModel>(instanceIdentifier, identifier);
            ...
            {
                var listOfRecords = (List<DerivedFromModel>)BusinessObjectsUtils.GetRecordsFromSession<DerivedFromModel>(instanceIdentifier, identifier);
            ...
            {
                var listOfRecords = (List<CategoriesModel>)BusinessObjectsUtils.GetRecordsFromSession<CategoriesModel>(instanceIdentifier, identifier);
