...
{
    public class EFD_QualityControlLevel : QualityControlLevel, ICuahsiUpload<QualityControlLevel>
    {
        //Interface members...
        ...
        public List<string> GetFields(FieldType ft)
        {
            ...
            switch (ft)
            {
                ...
                case FieldType.ftDuplicatesCheck:
                    result.Add(_fields[0]); //QualityControlLevelCode...
                    break;
                case FieldType.ftUpdatesCheck:
                    result.Add(_fields[1]); //Definition
                    result.Add(_fields[2]); //Explanation
                    break;
                default:
        ...
        public bool CopyTo(QualityControlLevel odmType, StringBuilder sbError)
        {
        ...
        public bool QueueDeleteAll(DbSet<QualityControlLevel> dbSet)
        {
